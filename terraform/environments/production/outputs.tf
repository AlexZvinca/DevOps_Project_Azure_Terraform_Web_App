...
output "network_security_group_name" {
  description = "Name of the production network security group"
  value       = module.network.network_security_group_name
}

output "public_ip_address" {
  description = "Public IP address created for the production environment"
  value       = module.network.public_ip_address
}

output "vm_name" {
  description = "Name of the production Linux virtual machine"
...
output "storage_account_name" {
  description = "Name of the production Azure Storage Account"
  value       = module.storage.storage_account_name
}

output "storage_container_name" {
  description = "Name of the production Blob Storage container"
